    ...
    return (
        <div className="bg-gradient-to-r from-blue-200 to-purple-200">
            ...
            <div className="grid grid-cols-2 gap-4 pb-4 justify-items-center">
                ...
                <div className="">
                    <img src="https://img.freepik.com/free-photo/chopsticks-bowls-thai-cuisine_23-2148093228.jpg?t=st=1683093036~exp=1683093636~hmac=b7de4d9f29c4a048931d0cb1ac5136c40e70a3b8d1fd38cf035ae9e0816e3c23" alt="" />
                </div>
                <div className="mt-4">
                    <img src="https://img.freepik.com/free-photo/front-view-vegan-salad-with-fresh-ingredients-plate-pepper-black-cutting-board_179666-47208.jpg?w=360&t=st=1683093243~exp=1683093843~hmac=45550389738a7c37f206af540783da6e285497383a85ff49bdceb818efca939b" alt="" />
                </div>
                </div>
            </div>
        </div>
